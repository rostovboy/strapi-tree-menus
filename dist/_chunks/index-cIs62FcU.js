...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-CTZyw-ny.js"));
        return App;
      },
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./TreeInput-OYAX5E-d.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-cIs62FcU.js.map
