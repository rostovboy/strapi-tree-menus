...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-DyO6P660.mjs");
        return App;
      },
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => import("./TreeInput-DyBbqM4d.mjs").then((module) => ({
  ...
  async registerTrads(app) {
    ...
    return await Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-CkBQaUfw.mjs") }), `./translations/${locale}.json`);
          return {
...
//# sourceMappingURL=index-CfJFWOIE.mjs.map
