...
const index = require("./index-CQoBlOQU.js");
...
const traverse__default = /* @__PURE__ */ _interopDefault(traverse);
...
const createYupSchema = (schemas) => {
  const fieldsSchema = schemas.reduce((schema, current) => {
    ...
    let validator = yup__namespace[validationType]();
  ...
  const itemSchema = yup__namespace.object().shape({ ...fieldsSchema, children: yup__namespace.array().of(yup__namespace.lazy(() => itemSchema)) });
  return yup__namespace.array().of(itemSchema);
};
const resetErrors = (items) => {
  traverse__default.default(items).forEach(function(value) {
    if (this.key === "errors") {
      this.remove();
    }
  });
...
const addErrorsToFields = (errors, items) => {
  errors.inner.forEach((error) => {
    ...
    const item = formik.getIn(items, path);
    if (item) {
      item.errors = error.message;
      formik.setIn(items, path, item);
    }
  });
  return items;
};
const sanitizeItems = (items) => {
  return traverse__default.default(items).map(function(value) {
...
function flatten(items, parentId = null, depth = 0) {
  return items.reduce((acc, item, index2) => {
    return [...acc, { ...item, parentId, depth, index: index2 }, ...flatten(item.children, item.id, depth + 1)];
  }, []);
}
...
const MenuDataProvider = ({ children, value, onChange, name, schema, disabled, error }) => {
  ...
  const validateSchema = React.useMemo(() => createYupSchema(schema.attributes), [schema.attributes]);
...
const useTreeData = () => React.useContext(MenuDataContext);
function _typeof(o) {
  ...
  const handleChange = async (field, fieldValue) => {
    if (activeItem) {
      ...
      if (!result.errors) {
        ...
        throw new yup.ValidationError(result.errors);
      }
    }
  };
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: activeItem ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Card, { padding: 2, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 3, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 12, s: 12, xs: 12, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", tag: "h3", children: formatMessage(
      {
        id: index.getTranslation("tree-menus.edit-form.title"),
        defaultMessage: "Edit {0}"
      },
      { 0: activeItem.title }
    ) }) }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 12, s: 12, xs: 12, children: /* @__PURE__ */ jsxRuntime.jsx(DividerFull, { marginBottom: 3 }) }),
    attributes.map((attribute) => {
      return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 12, s: 12, xs: 12, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(
        MemoizedGenericInput,
        {
          ...
          intlLabel: {
            id: index.getTranslation(`tree-menus.edit-form.${attribute.id}.label`),
            defaultMessage: attribute.label
          },
          labelAction: /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {}),
          onChange: (e) => handleChange(attribute.id, e.target.value),
          placeholder: {
            id: index.getTranslation(`tree-menus.edit-form.${attribute.id}.placeholder`),
...
`;
const Action = React.forwardRef(({ active, className, cursor, style, ...props }, ref) => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    ActionButton,
    {
      ref,
      ...props,
      className: classNames__default.default("Action", className),
      tabIndex: 0,
      style: {
        ...style,
        cursor,
...
function Edit(props) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    Action,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "12", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M441 58.9L453.1 71c9.4 9.4 9.4 24.6 0 33.9L424 134.1 377.9 88 407 58.9c9.4-9.4 24.6-9.4 33.9 0zM209.8 256.2L344 121.9 390.1 168 255.8 302.2c-2.9 2.9-6.5 5-10.4 6.1l-58.5 16.7 16.7-58.5c1.1-3.9 3.2-7.5 6.1-10.4zM373.1 25L175.8 222.2c-8.7 8.7-15 19.4-18.3 31.1l-28.6 100c-2.4 8.4-.1 17.4 6.1 23.6s15.2 8.5 23.6 6.1l100-28.6c11.8-3.4 22.5-9.7 31.1-18.3L487 138.9c28.1-28.1 28.1-73.7 0-101.8L474.9 25C446.8-3.1 401.2-3.1 373.1 25zM88 64C39.4 64 0 103.4 0 152L0 424c0 48.6 39.4 88 88 88l272 0c48.6 0 88-39.4 88-88l0-112c0-13.3-10.7-24-24-24s-24 10.7-24 24l0 112c0 22.1-17.9 40-40 40L88 464c-22.1 0-40-17.9-40-40l0-272c0-22.1 17.9-40 40-40l112 0c13.3 0 24-10.7 24-24s-10.7-24-24-24L88 64z" }) })
    }
  );
}
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Wrapper,
      {
        ...
        ...props,
        children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "TreeItem", ref, style, children: [
          !disabled && /* @__PURE__ */ jsxRuntime.jsx(Handle, { ...handleProps }),
          onCollapse && /* @__PURE__ */ jsxRuntime.jsx(Action, { onClick: onCollapse, className: classNames__default.default("Collapse", collapsed && "collapsed"), children: collapseIcon }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { className: "Text", children: value }),
          !clone && !disabled && onAdd && /* @__PURE__ */ jsxRuntime.jsx(Add, { onClick: onAdd }),
          !clone && !disabled && onEdit && /* @__PURE__ */ jsxRuntime.jsx(Edit, { onClick: onEdit }),
          !clone && !disabled && onRemove && /* @__PURE__ */ jsxRuntime.jsx(Remove, { onClick: onRemove }),
          clone && childCount && childCount > 1 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "Count", children: childCount }) : null
        ] })
      }
    );
  }
);
const collapseIcon = /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "10", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 70 41", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M30.76 39.2402C31.885 40.3638 33.41 40.995 35 40.995C36.59 40.995 38.115 40.3638 39.24 39.2402L68.24 10.2402C69.2998 9.10284 69.8768 7.59846 69.8494 6.04406C69.822 4.48965 69.1923 3.00657 68.093 1.90726C66.9937 0.807959 65.5106 0.178263 63.9562 0.150837C62.4018 0.123411 60.8974 0.700397 59.76 1.76024L35 26.5102L10.24 1.76024C9.10259 0.700397 7.59822 0.123411 6.04381 0.150837C4.4894 0.178263 3.00632 0.807959 1.90702 1.90726C0.807714 3.00657 0.178019 4.48965 0.150593 6.04406C0.123167 7.59846 0.700153 9.10284 1.75999 10.2402L30.76 39.2402Z" }) });
...
function SortableTreeItem({ id, depth, disabled, errors, ...props }) {
  const {
    ...
    transform,
    transition
  } = sortable.useSortable({ id, animateLayoutChanges, disabled });
  const style = {
...
function Remove(props) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    Action,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "12", viewBox: "0 0 22 22", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M2.99998 -0.000206962C2.7441 -0.000206962 2.48794 0.0972617 2.29294 0.292762L0.292945 2.29276C-0.0980552 2.68376 -0.0980552 3.31682 0.292945 3.70682L7.58591 10.9998L0.292945 18.2928C-0.0980552 18.6838 -0.0980552 19.3168 0.292945 19.7068L2.29294 21.7068C2.68394 22.0978 3.31701 22.0978 3.70701 21.7068L11 14.4139L18.2929 21.7068C18.6829 22.0978 19.317 22.0978 19.707 21.7068L21.707 19.7068C22.098 19.3158 22.098 18.6828 21.707 18.2928L14.414 10.9998L21.707 3.70682C22.098 3.31682 22.098 2.68276 21.707 2.29276L19.707 0.292762C19.316 -0.0982383 18.6829 -0.0982383 18.2929 0.292762L11 7.58573L3.70701 0.292762C3.51151 0.0972617 3.25585 -0.000206962 2.99998 -0.000206962Z" }) })
    }
  );
}
const Handle = React.forwardRef((props, ref) => {
  return /* @__PURE__ */ jsxRuntime.jsx(Action, { ref, cursor: "grab", "data-cypress": "draggable-handle", ...props, children: /* @__PURE__ */ jsxRuntime.jsx("svg", { viewBox: "0 0 20 20", width: "12", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M7 2a2 2 0 1 0 .001 4.001A2 2 0 0 0 7 2zm0 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 7 8zm0 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 7 14zm6-8a2 2 0 1 0-.001-4.001A2 2 0 0 0 13 6zm0 2a2 2 0 1 0 .001 4.001A2 2 0 0 0 13 8zm0 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 13 14z" }) }) });
});
...
const dropAnimationConfig = {
  keyframes({ transform }) {
    return [
      { opacity: 1, transform: utilities.CSS.Transform.toString(transform.initial) },
      {
        opacity: 0,
  ...
  sideEffects({ active }) {
    active.node.animate([{ opacity: 0 }, { opacity: 1 }], {
      duration: core.defaultDropAnimation.duration,
      easing: core.defaultDropAnimation.easing
    });
  }
};
function SortableTree({ collapsible, indicator = false, indentationWidth = 50, removable }) {
  ...
  const sensorContext = React.useRef({ items: flattenedItems, offset: offsetLeft });
  const [coordinateGetter] = React.useState(() => sortableTreeKeyboardCoordinates(sensorContext, indicator, indentationWidth));
  const sensors = core.useSensors(core.useSensor(core.PointerSensor), core.useSensor(core.KeyboardSensor, { coordinateGetter }));
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    core.DndContext,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(sortable.SortableContext, { items: sortedIds, strategy: sortable.verticalListSortingStrategy, children: [
        ...
        reactDom.createPortal(
          /* @__PURE__ */ jsxRuntime.jsx(core.DragOverlay, { dropAnimation: dropAnimationConfig, modifiers: indicator ? [adjustTranslate] : void 0, children: activeId && activeSelectedItem ? /* @__PURE__ */ jsxRuntime.jsx(
            SortableTreeItem,
            {
              id: activeId,
  ...
  function handleDragEnd({ active, over }) {
    ...
    if (projected && over) {
      ...
      const sortedItems = sortable.arrayMove(clonedItems, activeIndex, overIndex);
  ...
  function handleRemove(id) {
    const newItems = removeItem(lodash.cloneDeep(items), id);
    setItems(newItems);
    onChange(newItems);
  }
  function handleCollapse(id) {
    const newItems = setProperty(lodash.cloneDeep(items), id, "collapsed", (value) => {
      return !value;
    });
    setItems(newItems);
    onChange(newItems);
  ...
  async function handleAddItem(parentId = null) {
    let _items = lodash.cloneDeep(items);
    if (!parentId) {
      const newItem = {
        id: `${_items.length + 1}`,
...
const TreeInput = React__namespace.default.forwardRef(
  ({ hint, disabled = false, labelAction, label, name, required = false, onChange, value = [], error, ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsx(
      MenuDataProvider,
      {
        ...
        disabled,
        error,
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name, id: name, error, hint, required, children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { action: labelAction, children: label }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 4, marginTop: 10, children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 8, s: 12, xs: 12, alignItems: "start", justifyContent: "start", children: /* @__PURE__ */ jsxRuntime.jsx("ul", { style: { display: "flex", flexDirection: "column", flex: 1, gap: "5px" }, children: /* @__PURE__ */ jsxRuntime.jsx(SortableTree, { collapsible: true, indicator: true, removable: true }) }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 4, s: 12, xs: 12, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(FormLayout, {}) }) })
          ] })
        ] })
      }
    ) });
...
//# sourceMappingURL=TreeInput-DmbGZt0O.js.map
