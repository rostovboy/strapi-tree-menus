...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-qM770zsz.js"));
        return App;
      },
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./TreeInput-DmbGZt0O.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-CQoBlOQU.js.map
