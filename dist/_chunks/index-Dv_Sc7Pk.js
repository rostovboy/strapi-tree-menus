...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BVrPOSoT.js"));
        return App;
      },
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./TreeInput-B4_FLdq4.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-Dv_Sc7Pk.js.map
