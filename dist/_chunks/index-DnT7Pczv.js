...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, fill: "#8e8ea9", viewBox: "0 0 512 512", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zM448 160V416H64V160H96v64 96c0 26.5 21.5 48 48 48h96c8.8 0 16-7.2 16-16s-7.2-16-16-16H144c-8.8 0-16-7.2-16-16V269.3c5 1.8 10.4 2.7 16 2.7h32c8.8 0 16-7.2 16-16s-7.2-16-16-16H144c-8.8 0-16-7.2-16-16V160H448zM224 240v32c0 8.8 7.2 16 16 16H400c8.8 0 16-7.2 16-16V240c0-8.8-7.2-16-16-16H240c-8.8 0-16 7.2-16 16zm80 80c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h96c8.8 0 16-7.2 16-16V336c0-8.8-7.2-16-16-16H304z" }) });
const TreeIcon = () => /* @__PURE__ */ jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M16 64v64H40 56 80V64H16zm24 80H16 0V128 64 48H16 80 96V64v64 16H80 56V256h72V224 208h16 64 16v16 64 16H208 144 128V288 272H56V416h72V384 368h16 64 16v16 64 16H208 144 128V448 432H48 40v-8V264 144zM144 416v16 16h64V384H144v32zm0-128h64V224H144v32 16 16zM168 88h8H496h8v16h-8H176h-8V88zM296 248h8H496h8v16h-8H304h-8V248zm0 160h8H496h8v16h-8H304h-8V408z" }) });
const PERMISSIONS = {
  main: [
    {
      id: 159,
...
const ACTION_RESOLVE_CONFIG = `${PLUGIN_ID}/resolve-config`;
const initialState = {
  isLoading: true,
  config: {
    maxDepth: null,
...
const configReducer = fn((previousState, action) => {
...
const reducers = {
  [`${PLUGIN_ID}-config`]: configReducer
};
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-bsMfitKB.js"));
        return App;
      },
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./TreeInput-DZRRMzDk.js")).then((module2) => ({
          default: module2.TreeInput
        }))
      },
      options: {
        advanced: [
  ...
  async registerTrads(app) {
    ...
    return await Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-BAE0H1B8.js")) }), `./translations/${locale}.json`);
          return {
...
exports.index = index;
//# sourceMappingURL=index-DnT7Pczv.js.map
